...
class tbl_alumni(models.Model):
    ...
    company_name=models.CharField(max_length=48,null=True)
    placement_session=models.CharField(max_length=20,null=True)
...
class tbl_event(models.Model):
    ...
    event_link=models.CharField(max_length=50,null=True)
    posted_date=models.DateField(null=True)
...
class tbl_faculty(models.Model):
    ...
    qualification=models.CharField(max_length=48,null=True)
...
class tbl_courses(models.Model):
    ...
    view_link=models.CharField(max_length=50,null=True)
